...
<template>
    <nav class="relative flex w-full flex-nowrap items-center justify-between bg-secondary py-2 shadow-md lg:flex-wrap lg:justify-start lg:py-4">
        <div class="flex w-full flex-wrap items-center justify-between px-3">
            ...
            <div :class="{ 'hidden': !isNavbarOpen, 'flex': isNavbarOpen }"
                ...
                <div class="ms-2 mr-6 uppercase hidden lg:block">
                ...
                <ul class="list-style-none me-auto flex flex-col ps-0 lg:mt-1 lg:flex-row">
                    ...
                    <li class="mb-4 ps-2 lg:mb-0 lg:pe-1 lg:ps-0 relative">
                        <a class="flex items-center text-neutral transition duration-200 hover:text-neutral/80 hover:ease-in-out focus:text-neutral active:text-black/80 motion-reduce:transition-none lg:px-2 cursor-pointer"
                        ...
                        <ul v-if="isDropdownOpen"
                            class="dropdown-menu absolute z-10 mt-2 min-w-max list-none rounded-lg border-none bg-primary shadow-lg dark:bg-neutral-800">
                            <li>
                                <router-link to="/"
